...
const array = ['koyi','evide ellarum','fans','kollum','song','neeyo','polikki','vibe','nice','kunna','kuntan','Power varatte','hai','sherinnal','love you','girls','pani kittum','velachil','verithanam','polich','poli','avan vann','nee etha','podaudnn','oombi','chali','single','Sedakki','set','chanke','ayin','kundan','helo','kanjav','line illa','nanban','njan pavan','Aah','eythio','pani pali','nona','poora','poda','sed aaki','ishtano','power','music','bgm','vere level','friend','chirikkalle','power aayi','bot','miss','potta','viban','kalikkalle','pever','njan vann','kannappi','dai','njammal pavam','Ayin','Ayinu','Bgm','Bot','Bye','Da','Good night','Hello','Hi','Neymar','Pm','Sed','alive','assist','ban','bgm','bot','converting','fake','fork','fuck','music','myre','njan','number','oombi','para','poda','raganork','remove','reply','sed','subscribe','umma','xxxtentation']
array.map( async (a) => {i
